...
export PATH=/home/ruslan/hisat2-2.2.1:$PATH
export PATH=/home/ruslan/bwa:$PATH

reference='/home/ruslan/pou5/assemblies' # path to the folder with genome .fasta file
ht_index='hg38_ht2' # hisat index name
genome_fasta='hg38.fasta' # genome .fasta file itself, here I use only primary chromosomes
path_in='/home/shamil/human_muscles/final_fastq/merged_fastq_2_4_7' # path to final trimmed .fastq files
path_out='/home/shamil/human_muscles/mapped/runs_2_4_7_hg38' # output directory
...
bedtools bamtofastq -i ${res_file%.bwa.sai*}.bwa_unmapped.bam -fq ${res_file%.bwa.sai*}.bwa_unmapped.fastq;
